  ...
  <div className="card" style={{ background: '#fafdff', borderRadius: 16, boxShadow: '0 4px 16px #e0e4ea55', border: 'none', position: 'relative', maxWidth: 900, margin: '40px auto' }}>
    <div className="card-header" style={{ background: 'linear-gradient(90deg, #1976d2 0%, #43a047 100%)', borderRadius: '16px 16px 0 0', color: '#fff', boxShadow: '0 2px 8px #e0e4ea33', padding: '18px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        <h4 style={{ margin: 0, fontWeight: 700, fontSize: 22, letterSpacing: 1 }}><i className="menu-icon fas fa-exchange-alt" style={{ marginRight: 10 }}></i> Change Requests</h4>
      </div>
    ...
    <div className="card-body" style={{ padding: 32 }}>
      ...
      <div style={{ padding: 32, textAlign: 'center', color: '#888' }}>
        <i className="fas fa-exchange-alt" style={{ fontSize: 48, color: '#1976d2', marginBottom: 16 }}></i>
        <h5 style={{ fontWeight: 600, marginBottom: 12 }}>No Change Requests yet</h5>
        <p style={{ fontSize: 16 }}>Start by creating a new change request to manage project modifications.</p>
      </div>
    </div>
    {/* Floating Add Button */}
    <button
